...
/**
 * Created by mindiii on 15/10/18.
 */

public class EventImgeUploadAdapter extends RecyclerView.Adapter<EventImgeUploadAdapter.MyViewHolder> {
    ...
    public EventImgeUploadAdapter(List<ImageBean> imageBeans, ProfileImageAdapterListener listener) {
    ...
    @Override
    public EventImgeUploadAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
