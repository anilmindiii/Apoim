...
public class GioAddressTask extends AsyncTask<Void, Void, Void> {
    ...
    public interface LocationListner{
        void onSuccess(com.apoim.adapter.autocompleterAdapter.Address address);
    }

    public GioAddressTask(Context mContext, LatLng latLng){
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        if(address!=null){
            com.apoim.adapter.autocompleterAdapter.Address adr = new com.apoim.adapter.autocompleterAdapter.Address();
