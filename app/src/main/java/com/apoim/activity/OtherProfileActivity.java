...
public class OtherProfileActivity extends AppCompatActivity {
   // private ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_others_profile_layout);
        init();
            ...
            public void onClick(View view) {
                if(otherProfileInfo.UserDetail.isAppointment != null){
                    if(otherProfileInfo.UserDetail.isAppointment.equals("0")){
                        Intent intent = new Intent(OtherProfileActivity.this,CreateAppointMentActivity.class);
                        ...
                        Utils.openAlertDialog(OtherProfileActivity.this, "You already sent appointment request to "+otherProfileInfo.UserDetail.fullName);
                    }
                    else  if(otherProfileInfo.UserDetail.isAppointment.equals("2")){
                        Utils.openAlertDialog(OtherProfileActivity.this, "You already have an appointment with "+otherProfileInfo.UserDetail.fullName);
                    }
                }
            }
        });
...
*/
        ...
        iv_add_friend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(otherProfileInfo.UserDetail.isRequest.equals("1")){
                    Utils.openAlertDialog(OtherProfileActivity.this,"You already sent friend request to "+otherProfileInfo.UserDetail.fullName);
                }else {
        ...
        ly_business.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OtherProfileActivity.this, BusinessDetailsActivity.class);
    ...
    private void mobileVerificationSelcted() {
        ...
        tv_mobile_veri.setTextColor(ContextCompat.getColor(OtherProfileActivity.this, R.color.colorBlack));
    ...
    private void idWithHandSelcted() {
        ...
        tv_id_hand_veri.setTextColor(ContextCompat.getColor(OtherProfileActivity.this, R.color.colorBlack));
    ...
    private void faceDetectionSelcted() {
        ...
        tv_face_detection_veri.setTextColor(ContextCompat.getColor(OtherProfileActivity.this, R.color.colorBlack));
                ...
                try {
                    ...
                    if (status.equals("success")) {
                      ...
                      /*  if(otherProfileInfo.UserDetail.images.size() == 0){
                        ...
                        newProfileImageAdapter = new NewProfileAdapter(OtherProfileActivity.this, otherProfileInfo.UserDetail.profileImage, new GetNewImageClick() {
                            @Override
                        ...
                        viewPagerAdapter = new ViewPagerAdapter(OtherProfileActivity.this,otherProfileInfo.UserDetail.profileImage);
                        ...
                        for(int i = 0; i < dotscount; i++){
                            ...
                            dots[i] = new ImageView(OtherProfileActivity.this);
                            dots[i].setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.non_active_dot));
        ...
        switch (requestCode) {
            ...
            case Constant.MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(OtherProfileActivity.this, "YOU DENIED PERMISSION CANNOT SELECT IMAGE", Toast.LENGTH_LONG).show();
                }
            }
            break;
            ...
            case Constant.MY_PERMISSIONS_REQUEST_CEMERA: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(OtherProfileActivity.this, "YOUR  PERMISSION DENIED ", Toast.LENGTH_LONG).show();
                }
            }
            break;
...
//                    intent.putExtra(Intent.EXTRA_TEXT, "Today I'm grateful for...#gratitudemorning");
  ...
  if(!userDetail.fullName.equals("")){
        ...
        if(userDetail.isFavorite.equals("1")){
            iv_fevorate.setImageResource(R.drawable.star_active);
        }
                ...
                try {
                    ...
                    if(status.equals("success")){
                        ...
                        if( otherProfileInfo.UserDetail.isFavorite.equals("1")){
                            ...
                            // Utils.openAlertDialog(OtherProfileActivity.this,otherProfileInfo.UserDetail.fullName+" added to your favorite");
                        }else {
                            otherProfileInfo.UserDetail.isFavorite  = "0";
                            iv_fevorate.setImageResource(R.drawable.star);
                            //Utils.openAlertDialog(OtherProfileActivity.this,otherProfileInfo.UserDetail.fullName+" remove from your favorite");
                        }
