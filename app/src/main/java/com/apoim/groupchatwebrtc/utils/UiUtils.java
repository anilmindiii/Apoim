...
public class UiUtils {
    ...
    public static Drawable getGreyCircleDrawable() {
        return getColoredCircleDrawable(ResourceUtils.getColor(R.color.color_blue_qb));
    }
    ...
    public static int getCircleColor(@IntRange(from = RANDOM_COLOR_START_RANGE, to = RANDOM_COLOR_END_RANGE)
        ...
        int colorId = Apoim.getInstance().getResources()
                .getIdentifier(colorIdName, "color", Apoim.getInstance().getPackageName());
