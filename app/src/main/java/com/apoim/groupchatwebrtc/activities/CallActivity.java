...
import com.apoim.groupchatwebrtc.fragments.AudioConversationFragment;
import com.apoim.groupchatwebrtc.fragments.BaseConversationFragment;
import com.apoim.groupchatwebrtc.fragments.ConversationFragmentCallbackListener;
import com.apoim.groupchatwebrtc.fragments.IncomeCallFragment;
import com.apoim.groupchatwebrtc.fragments.IncomeCallFragmentCallbackListener;
import com.apoim.groupchatwebrtc.fragments.OnCallEventsController;
import com.apoim.groupchatwebrtc.fragments.ScreenShareFragment;
import com.apoim.groupchatwebrtc.fragments.VideoConversationFragment;
import com.apoim.groupchatwebrtc.util.NetworkConnectionChecker;
import com.apoim.groupchatwebrtc.utils.Consts;
import com.apoim.groupchatwebrtc.utils.FragmentExecuotr;
import com.apoim.groupchatwebrtc.utils.PermissionsChecker;
import com.apoim.groupchatwebrtc.utils.QBEntityCallbackImpl;
import com.apoim.groupchatwebrtc.utils.RingtonePlayer;
import com.apoim.groupchatwebrtc.utils.SettingsUtil;
...
public class CallActivity extends BaseActivity implements QBRTCClientSessionCallbacks, QBRTCSessionStateCallback<QBRTCSession>, QBRTCSignalingCallback,
   ...
   /* private String id = "";
    ...
    // Anils code
    public static void start(Context context, boolean isIncomingCall,String id,String name) {
        Intent intent = new Intent(context, CallActivity.class);
        intent.putExtra(Consts.EXTRA_IS_INCOMING_CALL, isIncomingCall);
